  ...
  return (
    <div className="auth-card__content">
      <div className="auth-card__header" style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "22px" }}>
        ...
        <h2 className="auth-card__title" style={{ margin: 0, fontSize: "20px", fontWeight: 500 }}>Login</h2>
      </div>
      ...
      <div className="auth-card__footer" style={{ textAlign: "center", marginTop: "42px", fontSize: "11px", color: "#374151" }}>
